...
#main variables
API_ID = int(environ.get('28218866', ''))
API_HASH = environ.get('e3565e7ed0e0b4ac482c51db4d260bc2', '')
BOT_TOKEN = environ.get('BOT_TOKEN', '8123473959:AAGXY8-gowQVt2d9JUpvYA9M9hy8KBrLL4g')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1365183907').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/TeamX0wner")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002658272163'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/CinemaGraphy14')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '- -1002331642587').split()]
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://filmsclubprovider:o3pZCzTD1mGjjgFT@cluster0.sf5gjkn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

DATABASE_NAME = environ.get('DATABASE_NAME', "TELEGRAM_BOT_INFO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002658272163)
